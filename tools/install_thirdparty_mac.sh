...
wget -nv --show-progress -O libzetasql.tar.gz https://github.com/jingchen2222/zetasql/releases/download/v0.2.0-support-float32-literal/libzetasql-0.2.0-support-float32-literal-darwin-x86_64.tar.gz

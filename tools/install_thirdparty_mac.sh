...
wget -nv --show-progress https://github.com/jingchen2222/zetasql/releases/download/v0.2.0-beta6/libzetasql-0.2.0-beta6-darwin-x86_64.tar.gz
tar xzf libzetasql-0.2.0-beta6-darwin-x86_64.tar.gz -C  "${CICD_RUNNER_THIRDPARTY_PATH}" --strip-components 1

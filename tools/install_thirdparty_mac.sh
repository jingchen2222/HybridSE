...
wget -nv --show-progress https://github.com/jingchen2222/hybridsql-asserts/releases/download/v0.3.1/thirdparty-2021-05-21-drawin-x86_64.tar.gz -o thirdparty.tar.gz
tar xzf thirdparty.tar.gz -C  "${CICD_RUNNER_THIRDPARTY_PATH}" --strip-components 1
# download and install libzetasql
wget -nv --show-progress https://github.com/jingchen2222/zetasql/releases/download/v0.2.0-beta2/libzetasql-0.2.0-beta2-darwin-x86_64.tar.gz -o libzetasql.tar.gz

...
then
    ...
    if [[ ! -d thirdparty && -r thirdparty.tar.gz ]]; then
        ...
        curl -SL -o libzetasql.tar.gz https://github.com/jingchen2222/zetasql/releases/download/v0.2.0-support-float32-literal/libzetasql-0.2.0-support-float32-literal-linux-x86_64.tar.gz

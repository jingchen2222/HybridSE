...
class ExprIRBuilder {
 ...
 private:
    ...
    bool BuildCallFnLegacy(const ::hybridse::node::CallExprNode* call_fn, NativeValue* output,
    ...
    ::llvm::Function* GetFuncion(const std::string& col, const std::vector<const node::TypeNode*>& generic_types,

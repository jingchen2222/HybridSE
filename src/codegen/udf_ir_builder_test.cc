...
TEST_F(UdfIRBuilderTest, concat_str_udf_test) {
    //    concat("12345") == "12345"
    CheckUdf<StringRef, StringRef>("concat", StringRef("12345"), StringRef(std::string("12345")));

    // concat("12345", "67890") == "1234567890"
    CheckUdf<StringRef, StringRef, StringRef>("concat", StringRef("1234567890"), StringRef(std::string("12345")),
                                              StringRef("67890"));

    // concat("123", "4567890", "abcde") == "1234567890abcde"
    CheckUdf<StringRef, StringRef, StringRef, StringRef>("concat", StringRef("1234567890abcde"),
                                                         StringRef(std::string("123")), StringRef("4567890"),
                                                         StringRef("abcde"));
...
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_0) {
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", codec::Timestamp(1589904000000L),
                                                  codec::Date(2020, 05, 20));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_0) {
    //    Invalid year
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, codec::Date(1899, 05, 20));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_1) {
    //    Invalid month
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, codec::Date(2029, 13, 20));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_2) {
    //    Invalid day
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, codec::Date(2029, 05, 32));
}
...
TEST_F(UdfIRBuilderTest, string_to_timestamp_test_0) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", codec::Timestamp(1589907723000),
                                                       codec::StringRef("2020-05-20 01:02:03"));
}
TEST_F(UdfIRBuilderTest, string_to_timestamp_test_1) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", codec::Timestamp(1589904000000L),
                                                       codec::StringRef("2020-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_timestamp_test_2) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", nullptr, codec::StringRef("1899-05-20"));
}
...
TEST_F(UdfIRBuilderTest, timestamp_to_date_test_0) {
    CheckUdf<Nullable<Date>, Nullable<Timestamp>>("date", codec::Date(2020, 05, 20), codec::Timestamp(1589958000000L));
}
...
TEST_F(UdfIRBuilderTest, string_to_date_test_0) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", codec::Date(2020, 05, 20),
                                                  codec::StringRef("2020-05-20 01:02:03"));
}
TEST_F(UdfIRBuilderTest, string_to_date_test_1) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", codec::Date(2020, 05, 20), codec::StringRef("2020-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_date_test_2) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", nullptr, codec::StringRef("1899-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_date_test_3) {
    CheckUdf<Nullable<codec::Date>, Nullable<StringRef>>("date", codec::Date(2020, 05, 20),
                                                         codec::StringRef("20200520"));
}
TEST_F(UdfIRBuilderTest, string_to_smallint_0) {
    CheckUdf<Nullable<int16_t>, Nullable<StringRef>>("int16", 1, codec::StringRef("1"));
}
TEST_F(UdfIRBuilderTest, string_to_smallint_1) {
    CheckUdf<Nullable<int16_t>, Nullable<StringRef>>("int16", -1, codec::StringRef("-1"));
}
TEST_F(UdfIRBuilderTest, string_to_smallint_2) {
    CheckUdf<Nullable<int16_t>, Nullable<StringRef>>("int16", nullptr, codec::StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_int_0) {
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>>("int32", 1, codec::StringRef("1"));
}
TEST_F(UdfIRBuilderTest, string_to_int_1) {
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>>("int32", -1, codec::StringRef("-1"));
}
TEST_F(UdfIRBuilderTest, string_to_int_2) {
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>>("int32", nullptr, codec::StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_bigint_0) {
    CheckUdf<Nullable<int64_t>, Nullable<StringRef>>("int64", 1589904000000L, codec::StringRef("1589904000000"));
}
TEST_F(UdfIRBuilderTest, string_to_bigint_1) {
    CheckUdf<Nullable<int64_t>, Nullable<StringRef>>("int64", -1589904000000L, codec::StringRef("-1589904000000"));
}
TEST_F(UdfIRBuilderTest, string_to_bigint_2) {
    CheckUdf<Nullable<int64_t>, Nullable<StringRef>>("int64", nullptr, codec::StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_double_0) {
    CheckUdf<Nullable<double>, Nullable<StringRef>>("double", 1.0, codec::StringRef("1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_double_1) {
    CheckUdf<Nullable<double>, Nullable<StringRef>>("double", -1.0, codec::StringRef("-1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_double_2) {
    CheckUdf<Nullable<double>, Nullable<StringRef>>("double", nullptr, codec::StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_float_0) {
    CheckUdf<Nullable<float>, Nullable<StringRef>>("float", 1.0f, codec::StringRef("1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_float_1) {
    CheckUdf<Nullable<float>, Nullable<StringRef>>("float", -1.0f, codec::StringRef("-1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_float_2) {
    CheckUdf<Nullable<float>, Nullable<StringRef>>("float", nullptr, codec::StringRef("abc"));
}
}  // namespace codegen
}  // namespace hybridse
